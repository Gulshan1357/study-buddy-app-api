...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference("Slot.count") do
      post slots_url, params: { slot: { start_time: @slot.start_time, user_id: @slot.user_id } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { start_time: @slot.start_time, user_id: @slot.user_id } }
